 ...
 * @abstract
 * @param {CreditCard} profile - the credit card associated to the payment (todo allow customer profile etc)
 ...
 * </d>
 */
BaseGateway.prototype.createSubscription = function createSubscription(profile, subscriptionPlan, other) {
    return Promise.reject(throwNotImplemented());
};
